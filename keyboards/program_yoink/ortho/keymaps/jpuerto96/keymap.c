...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_split(
        KC_Q, KC_W, KC_E,    KC_R,    KC_T, _______, _______, KC_Y, KC_U,    KC_I,    KC_O,   KC_P, _______,
        ALT_A, GUI_S, SFT_D, CTL_F,    KC_G, _______, _______, KC_H, CTL_J,   SFT_K,   GUI_L,  ALT_SC, _______,
        KC_Z, KC_X, KC_C,    KC_V,    KC_B, _______, _______, KC_N, KC_M,    KC_COMM, KC_DOT, KC_SLSH, _______,
        _______, LOWER, KC_TAB,  KC_SPC,  KC_ENT, KC_BSPC, RAISE, _______,  _______,  _______
    ),
